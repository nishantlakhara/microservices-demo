...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private void simulateTwitterStream(String[] keywords, int minTweetLength, int maxTweetLength, long sleepTimeMs) throws TwitterException {
        Executors.newSingleThreadExecutor().submit(() -> {
            LOG.info("Starting simulated stream.");
            try {
                while (true) {
                    String formatterTweetAsRawJson = getFormattedText(keywords, minTweetLength, maxTweetLength);
    ...
    private String getFormattedText(String[] keywords, int minTweetLength, int maxTweetLength) {
